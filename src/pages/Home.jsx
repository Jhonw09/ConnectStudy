  ...
  return (
    <>
      <section className="book-intro">
          ...
          <div className="book-3d">
            <div className="book-face book-front">
              <div className="book-cover-content">
                <img src="/images/2.png" alt="StudyConnect" className="book-logo-img" />
                <h2>StudyConnect</h2>
                <p className="book-subtitle">Plataforma de Estudos</p>
              </div>
            </div>
        ...
        <button className="book-intro-hint" onClick={() => document.querySelector('.hero').scrollIntoView({ behavior: 'smooth', block: 'start' })}>
          <span className="hint-label">explorar</span>
          <svg className="hint-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none">
